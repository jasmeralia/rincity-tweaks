$(document).ready(function () {
    ...
    // open. Must intercept touchstart (not click) — some browsers follow links
    // on touchend before the synthesized click ever fires, making preventDefault
    // on click too late.
    //
    // Behavior:
    ...
    (function () {
        ...
        $mainMenu.find('.menu-item-has-children > a').on('touchstart', function (e) {
            var $li  = $(this).parent();
        ...
        $(document).on('touchstart.main-nav', function (e) {
